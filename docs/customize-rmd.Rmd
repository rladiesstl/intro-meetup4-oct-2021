...
subtitle: "R-Ladies St. Louis<br><br><br><br><br><br>"
author: "Mine Çetinkaya-Rundel"
date: "[bit.ly/custom-rmd-stl](https://bit.ly/custom-rmd-stl)"
output:
...
- Go to [bit.ly/custom-rmd-stl-cloud](https://bit.ly/custom-rmd-stl-cloud), create an account/log in, save a permanent copy of the project

- Go to [github.com/rladiesstl/intro-meetup4-oct-2021/](https://github.com/rladiesstl/intro-meetup4-oct-2021/), clone the repo, follow along in `exercises/`
...
.midi[
.hand[follow along at] [bit.ly/custom-rmd-stl-cloud](https://bit.ly/custom-rmd-stl-cloud)
]
...
<iframe src="https://app.sli.do/event/tvtffkpx" height="100%" width="100%" frameBorder="0" style="min-height: 560px;" title="Slido"></iframe>
...
.large[
.hand[
thank you! <br><br> [bit.ly/custom-rmd-stl](https://bit.ly/custom-rmd-stl)
]
]
]